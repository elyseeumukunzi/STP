...
<?php
	...
	if(isset($_POST['previewbtn']))
	{
		...
		if(isset($_POST['idpresta']))
		{
			...
			$tablidprestationConsu = $_POST['idpresta'];
			for ($i=0; $i <sizeof($tablidprestationConsu) ; $i++) { 
				...
				$valueGroupBy->execute(array(
					'idprestaConsu'=>$tablidprestationConsu[$i],
					'numPa'=>$numPa
				));

				$valueGroupBy->setFetchMode(PDO::FETCH_OBJ);

				if ($updatePriceGroupBy=$valueGroupBy->fetch()) {
					//print_r($updatePriceGroupBy);
					$updateprice = $connexion->query('UPDATE med_consult_hosp mc SET mc.prixprestationConsu='.$prixmco[$i].',mc.prixprestationConsuCCO='.$prixmcoCCO[$i].'');
		...
		if(isset($_POST['idprestaSurge']))
		{
			...
			/*Update the value Group by*/
			//Recuperer les valeurs du tableau
			$tablidprestationSurge = $_POST['idprestaSurge'];
			for ($i=0; $i <sizeof($tablidprestationSurge) ; $i++) { 
				...
				$valueGroupBy->execute(array(
					'idprestaSurge'=>$tablidprestationSurge[$i],
					'numPa'=>$numPa
				));
				...
				if ($updatePriceGroupBy=$valueGroupBy->fetch()) {
					//print_r($updatePriceGroupBy);
					$updateprice = $connexion->query('UPDATE med_surge_hosp ms SET ms.prixprestationSurge='.$prixms[$i].',ms.prixprestationSurgeCCO='.$prixmsCCO[$i].'');
					/*$compt = $updateprice->rowCount();
					if ($compt) {
					 	echo 'OK';
					}*/ 
		...
		if(isset($_POST['idprestaInf']))
		{
			...
			/*Update the value Group by*/
			//Recuperer les valeurs du tableau
			$tablidprestationInf = $_POST['idprestaInf'];
			for ($i=0; $i <sizeof($tablidprestationInf) ; $i++) { 
				...
				$valueGroupBy->execute(array(
					'idpresta'=>$tablidprestationInf[$i],
					'numPa'=>$numPa
				));
				...
				if ($updatePriceGroupBy=$valueGroupBy->fetch()) {
					$updateprice = $connexion->query('UPDATE med_inf_hosp mi SET mi.prixprestation='.$prixmi[$i].',mi.prixprestationCCO='.$prixmiCCO[$i].'');
				}
			}
		}
		...
		if(isset($_POST['idprestaLab']))
		{
			...
			/*Update the value Group by*/
			//Recuperer les valeurs du tableau
			$tablidprestationLabo = $_POST['idprestaLab'];
			for ($i=0; $i <sizeof($tablidprestationLabo) ; $i++) { 
				...
				$valueGroupBy->execute(array(
					'idprestaExa'=>$tablidprestationLabo[$i],
					'numPa'=>$numPa
				));
				...
				if ($updatePriceGroupBy=$valueGroupBy->fetch()) {
					$updateprice = $connexion->query('UPDATE med_labo_hosp ml SET ml.prixprestationExa='.$prixml[$i].',ml.prixprestationExaCCO='.$prixmlCCO[$i].'');
				}
			}
		}
		...
		if(isset($_POST['idprestaRad']))
		{
			...
			/*Update the value Group by*/
			//Recuperer les valeurs du tableau
			$tablidprestationRadio = $_POST['idprestaRad'];
			for ($i=0; $i <sizeof($tablidprestationRadio) ; $i++) { 
				...
				$valueGroupBy->execute(array(
					'idprestaRadio'=>$tablidprestationRadio[$i],
					'numPa'=>$numPa
				));
				...
				if ($updatePriceGroupBy=$valueGroupBy->fetch()) {
					$updateprice = $connexion->query('UPDATE med_radio_hosp mr SET mr.prixprestationRadio='.$prixmr[$i].',mr.prixprestationRadioCCO='.$prixmrCCO[$i].'');
				}
			}
		}
        ...
        if(isset($_POST['idprestaKine']))
        {
            ...
            /*Update the value Group by*/
			//Recuperer les valeurs du tableau
			$tablidprestationKine = $_POST['idprestaKine'];
			for ($i=0; $i <sizeof($tablidprestationKine) ; $i++) { 
				...
				$valueGroupBy->execute(array(
					'idprestaKine'=>$tablidprestationKine[$i],
					'numPa'=>$numPa
				));
				...
				if ($updatePriceGroupBy=$valueGroupBy->fetch()) {
					//print_r($updatePriceGroupBy);
					$updateprice = $connexion->query('UPDATE med_Kine_hosp mco SET mco.prixprestationKine='.$prixmk[$i].',mco.prixprestationKineCCO='.$prixmkCCO[$i].'');
					/*$compt = $updateprice->rowCount();
					if ($compt) {
					 	echo 'OK';
					}*/ 
    ...
    /*-------Requête pour AFFICHER med_consom_hosp-----------*/
		...
		if(isset($_POST['idprestaConsom']))
		{
			...
			/*Update the value Group by*/
			//Recuperer les valeurs du tableau
			$tablidprestationConsom = $_POST['idprestaConsom'];
			for ($i=0; $i <sizeof($tablidprestationConsom) ; $i++) { 
				...
				$valueGroupBy->execute(array(
					'idprestaconsom'=>$tablidprestationConsom[$i],
					'numPa'=>$numPa
				));
				...
				if ($updatePriceGroupBy=$valueGroupBy->fetch()) {
					//print_r($updatePriceGroupBy);
					$updateprice = $connexion->query('UPDATE med_consom_hosp mco SET mco.prixprestationConsom='.$prixmco[$i].',mco.prixprestationConsomCCO='.$prixmcoCCO[$i].'');
					/*$compt = $updateprice->rowCount();
					if ($compt) {
					 	echo 'OK';
					}*/ 
		...
		if(isset($_POST['idprestaMedoc']))
		{
			...
			/*Update the value Group by*/
			//Recuperer les valeurs du tableau
			$tablidprestationMedoc = $_POST['idprestaMedoc'];
			for ($i=0; $i <sizeof($tablidprestationMedoc) ; $i++) { 
				...
				$valueGroupBy->execute(array(
					'idprestaMedoc'=>$tablidprestationMedoc[$i],
					'numPa'=>$numPa
				));
				...
				if ($updatePriceGroupBy=$valueGroupBy->fetch()) {
					//print_r($updatePriceGroupBy);
					$updateprice = $connexion->query('UPDATE med_medoc_hosp mdo SET mdo.prixprestationMedoc='.$prixmdo[$i].',mdo.prixprestationMedocCCO='.$prixmdoCCO[$i].'');
					/*$compt = $updateprice->rowCount();
					if ($compt) {
					 	echo 'OK';
					}*/ 
        ...
        if(isset($_POST['idprestaOrtho']))
        {
            ...
            /*Update the value Group by*/
			//Recuperer les valeurs du tableau
			$tablidprestationOrtho = $_POST['idprestaOrtho'];
			for ($i=0; $i <sizeof($tablidprestationOrtho) ; $i++) { 
				...
				$valueGroupBy->execute(array(
					'idprestaOrtho'=>$tablidprestationOrtho[$i],
					'numPa'=>$numPa
				));
				...
				if ($updatePriceGroupBy=$valueGroupBy->fetch()) {
					//print_r($updatePriceGroupBy);
					$updateprice = $connexion->query('UPDATE med_ortho_hosp mo SET mdo.prixprestationOrtho='.$prixmo[$i].',mo.prixprestationOrthoCCO='.$prixmoCCO[$i].'');
					/*$compt = $updateprice->rowCount();
					if ($compt) {
					 	echo 'OK';
					}*/ 
