...
$arrayConsomReport= unserialize($_POST['arrayConsom']);
	...
	?>
		<div id="divPersoMedicReport">
			...
			?>
				...
				?>
					...
					$resultatsPrestaLabo=$connexion->prepare('SELECT *FROM '.$presta_assuConsom.' p, med_labo ml WHERE ml.numero=:num AND p.id_prestation=ml.id_prestationExa '.$dailydateperso.' AND ml.examenfait=1 AND p.id_souscategopresta='.$idsouscatego.' ORDER BY ml.dateresultats DESC');		
					...
					?>
						...
						<tr style="text-align:center;">
							...
							{		
								...
								$resultMoremedconsom=$connexion->prepare('SELECT *FROM more_med_labo mml WHERE mml.numero=:num AND mml.id_medconsom=:idmedLab ORDER BY mml.id_moremedconsom');		
								$resultMoremedconsom->execute(array(
								'num'=>$_GET['num'],
								'idmedLab'=>$lignePrestaLabo->id_medconsom
								));
								
								$resultMoremedconsom->setFetchMode(PDO::FETCH_OBJ);

								$comptMoremedconsom=$resultMoremedconsom->rowCount();
								
								while($ligneMoremedconsom=$resultMoremedconsom->fetch())
								{
									$idassuLab=$ligneMoremedconsom->id_assuLab;
								...
								<tr>
									...
									<?php
										$resultPresta=$connexion->prepare('SELECT *FROM '.$presta_assuConsom.' p WHERE p.id_prestation=:prestaId');		
										$resultPresta->execute(array(
										'prestaId'=>$ligneMoremedconsom->id_prestationExa
										));
										...
										if($lignePresta=$resultPresta->fetch())//on recupere la liste des éléments
										{
											...
											$moreexamen=$ligneMoremedconsom->autreExamen;
											$mesure='';				
										}
										echo $moreexamen;
									?>
									...
									<?php 
										$resultats=$ligneMoremedconsom->autreresultats;
										echo $ligneMoremedconsom->autreresultats.''.$mesure;
									?>
									</td>
								...
								if($ligneMoremedconsom->minresultats =="")
								{
									if($comptExa ==1)
									{
									...
									echo $ligneMoremedconsom->minresultats;
									$minresultats=$ligneMoremedconsom->minresultats;
								}
									?>
									</td>
								...
								if($ligneMoremedconsom->maxresultats =="")
								{
									if($comptExa ==1)
									{
										$ligneMin=$resultExa->fetch();
									...
									echo $ligneMoremedconsom->maxresultats;
								}
									?>
									</td>
									...
									<td style="text-align:center;">
									<?php 
									if($ligneMoremedconsom->resultats!="")
									{
							...
							if($lignePrestaLabo->moreresultats==2)
							{
								...
								$resultSpermomedconsom=$connexion->prepare('SELECT *FROM spermo_med_labo sml WHERE sml.numero=:num AND sml.id_medconsom=:idmedLab ORDER BY sml.id_spermomedconsom');		
								$resultSpermomedconsom->execute(array(
								'num'=>$_GET['num'],
								'idmedLab'=>$lignePrestaLabo->id_medconsom
								));
								
								$resultSpermomedconsom->setFetchMode(PDO::FETCH_OBJ);

								$comptSpermomedconsom=$resultSpermomedconsom->rowCount();
								
								while($ligneSpermomedconsom=$resultSpermomedconsom->fetch())
								{
								?>									
								...
								<tr>							
									<td style='text-align:center'>
									<?php echo $ligneSpermomedconsom->volume;?>
									</td>						
									<td style='text-align:center'>
									<?php echo $ligneSpermomedconsom->densite;?>
									</td>						
									<td style='text-align:center'>
									<?php echo $ligneSpermomedconsom->viscosite;?>
									</td>						
									<td style='text-align:center'>
									<?php echo $ligneSpermomedconsom->ph;?>
									</td>						
									<td style='text-align:center'>
									<?php echo $ligneSpermomedconsom->aspect;?>
									</td>
									
									<td style='border-left:1px solid #aaa;text-align:center'>
									<?php echo $ligneSpermomedconsom->examdirect;?>
									</td>
									...
									<td>							
										<table>
											...
											<tr>
												<td style='text-align:center'>
												<?php echo $ligneSpermomedconsom->zeroheureafter;?>
												</td>
												<td style='text-align:center'>
												<?php echo $ligneSpermomedconsom->uneheureafter;?>
												</td>
												<td style='text-align:center'>
												<?php echo $ligneSpermomedconsom->deuxheureafter;?>
												</td>
												<td style='text-align:center'>
												<?php echo $ligneSpermomedconsom->troisheureafter;?>
												</td>
												<td style='text-align:center'>
												<?php echo $ligneSpermomedconsom->quatreheureafter;?>
												</td>
											</tr>
										</table>
									</td>
									...
									<td style='text-align:center;font-weight:normal;'>
									<?php echo $ligneSpermomedconsom->numeration;?>
									</td>
									
									<td style='text-align:center'>
									<?php echo $ligneSpermomedconsom->vn;?>
									</td>
									...
									<td>
										<table>
											...
											<tr>
												<td style='text-align:center'>
												<?php echo $ligneSpermomedconsom->formtypik;?>
												</td>
												<td style='text-align:center'>
												<?php echo $ligneSpermomedconsom->formatypik;?>
												</td>
											</tr>
										</table>
									</td>
									...
									<td style='text-align:center'>
									<?php echo $ligneSpermomedconsom->autre;?>
									</td>
								...
								<tr>	
									...
									<?php echo $ligneSpermomedconsom->conclusion;?>
									</td>
						...
						<tr style="text-align:center;">
							...
							{							
								...
								<tr>
									...
									<td style="text-align:center;">
									<?php 
										$maxresultats=$ligneMoremedconsom->maxresultats;
										echo $ligneMoremedconsom->maxresultats;
									?>
									</td>
		...
		<?php
			...
			if(isset($_GET['createReportExcel']))
			{
				...
				if($_GET['paVisit']=='dailyPersoMedic')
				{
					$objWriter->save('C:/Users/ADMIN/Documents/Reports/MaterielsReport/Daily/'.$reportsn.'.xlsx');
							
					$callEndTime = microtime(true);
					$callTime = $callEndTime - $callStartTime;
					
					echo '<script type="text/javascript"> alert("File name : '.$reportsn.'.xlsx \n Saved in \n C:/Users/ADMIN/Documents/Reports/MaterielsReport/Daily/");</script>';
					...
					if($_GET['paVisit']=='monthlyPersoMedic')
					{
						$objWriter->save('C:/Users/ADMIN/Documents/Reports/MaterielsReport/Monthly/'.$reportsn.'.xlsx');
							
						$callEndTime = microtime(true);
						$callTime = $callEndTime - $callStartTime;
						
						echo '<script type="text/javascript"> alert("File name : '.$reportsn.'.xlsx \n Saved in \n C:/Users/ADMIN/Documents/Reports/MaterielsReport/Monthly/");</script>';
						...
						if($_GET['paVisit']=='annualyPersoMedic')
						{
							$objWriter->save('C:/Users/ADMIN/Documents/Reports/MaterielsReport/Annualy/'.$reportsn.'.xlsx');
							
							$callEndTime = microtime(true);
							$callTime = $callEndTime - $callStartTime;
							
							echo '<script type="text/javascript"> alert("File name : '.$reportsn.'.xlsx \n Saved in \n C:/Users/ADMIN/Documents/Reports/MaterielsReport/Annualy/");</script>';
							...
							if($_GET['paVisit']=='customPersoMedic')
							{
								$objWriter->save('C:/Users/ADMIN/Documents/Reports/MaterielsReport/Custom/'.$reportsn.'.xlsx');
							
								$callEndTime = microtime(true);
								$callTime = $callEndTime - $callStartTime;
								
								echo '<script type="text/javascript"> alert("File name : '.$reportsn.'.xlsx \n Saved in \n C:/Users/ADMIN/Documents/Reports/MaterielsReport/Custom/");</script>';
								...
								if($_GET['paVisit']=='gnlPersoMedic')
								{
									$objWriter->save('C:/Users/ADMIN/Documents/Reports/MaterielsReport/Alltimes/'.$reportsn.'.xlsx');
							
									$callEndTime = microtime(true);
									$callTime = $callEndTime - $callStartTime;
									
									echo '<script type="text/javascript"> alert("File name : '.$reportsn.'.xlsx \n Saved in \n C:/Users/ADMIN/Documents/Reports/MaterielsReport/Alltimes/");</script>';
		...
		<div id="divPersoMedicReport">
			...
			<table cellspacing="0" style="margin:10px auto auto; background:#fff; width:100%;">
				<tr>
					...
					<td style="text-align:center; width:50%;">
						<b><h3 style="padding:10px; font-size:150%;">Materials Report #<?php echo $sn;?></h3></b>
					</td>
				...
				foreach($arrayConsomReport as $key => $medconsom)
				{
					...
					<tr>
						...
						<?php
							...
							$fullnamePa = $arrayConsomReport[$key]['numero']['full_name'].' ('.$arrayConsomReport[$key]['numero']['numero'].')';
								
							if($fullnamePaCheck!=$fullnamePa)
							{
								echo $arrayConsomReport[$key]['numero']['full_name'].' ('.$arrayConsomReport[$key]['numero']['numero'].')';
							}
						?>
						</td>
						...
						{
							$dateconsom=date('d-M-Y',strtotime($arrayConsomReport[$key]['dateconsu']));
							echo $dateconsom;
						}else{
							$dateconsom="";
						}
						...
						<td style="text-align:center;font-weight:bold;">
							...
							if($arrayConsomReport[$key]['id_prestationConsom']!=0)
							{
								$resultPresta=$connexion->prepare('SELECT *FROM '.$presta_assuConsom.' p WHERE p.id_prestation=:prestaId');		
								$resultPresta->execute(array(
								...
								{	
									if($lignePresta->namepresta!='')
									{
										$consomPresta=$lignePresta->namepresta;					
									}else{
									
										$consomPresta=$lignePresta->nompresta;
									}
								}
							}else{
								$consomPresta=$arrayConsomReport[$key]['autreConsom'];
							}
							$qteConsomPresta=$arrayConsomReport[$key]['qteConsom'];
							echo $consomPresta.'<span style="margin:5px; padding-left:5px; border-left:1px solid #aaa;">'.$qteConsomPresta.'</span>';
							?>
						</td>						
						...
						{
							$caissierName=$arrayConsomReport[$key]['codecashier']['full_name'];
						}else{
							$caissierName="";
						}
						...
						{
							$nommedecin=$arrayConsomReport[$key]['id_uM']['full_name'];
						}else{
							$nommedecin="";
						}
						...
						{
							$infName= $arrayConsomReport[$key]['id_uInfConsom']['full_name'];
						}else{
							$infName="";
						}
					...
					<?php
	$qteConsomPrestaTotal=$qteConsomPrestaTotal+$qteConsomPresta;
						...
						$arrayConsult[$i][2]=$dateconsom;
						$arrayConsult[$i][3]=$consomPresta;
						$arrayConsult[$i][4]=$qteConsomPresta;
					...
					$objPHPExcel->setActiveSheetIndex(0)
								->fromArray($arrayConsult,'','A10')
								->setCellValue('E'.(10+$i).'', ''.$qteConsomPrestaTotal.'');
