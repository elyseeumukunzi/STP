	...
	?>
		...
		<?php
			...
			{				
				...
				echo '<script text="text/javascript">document.location.href="doctor_report.php?med='.$_GET['med'].'&dailydateperso='.$_GET['dailydateperso'].'&docVisit='.$_GET['docVisit'].'&stringResult='.$_GET['stringResult'].'&divPersoMedicReport=ok&createReportPdf=ok&createRN=0"</script>';
			}			
		}
