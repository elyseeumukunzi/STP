	...
	<table style="width:50%; margin-top:20px;font-size:15px;" align="center">		
		...
		<tr>
            ...
            //echo $_GET['dailydateperso'];
                $selectExpeReport=$connexion->prepare('SELECT * FROM expenses WHERE doneby=:doneby '.$dailydateperso.'');
							...
							$TotalTypeConsuBalance = ($TotalTypeConsuPatient + $TotalTypeConsuInsu);
								...
								<td style="text-align:center;">
									...
									//$TotalDayPricePatientBalance = ($TotalDayPriceBalance * $billArray[$b]['billpercent'])/100;
                                        ...
                                        $detteselect->execute(array('numero'=>$billArray[$b]['numero'],'numbill'=>$billArray[$b]['numbill']));
								...
								<tr style="text-align:center;">
									...
									<td style="font-size: 13px; font-weight: bold;">
										...
										$BTotalGnlPricePatientBalance = $TotalGnlPricePatient;
											echo $TotalGnlPricePatientBalance = $BTotalGnlPricePatientBalance - $TotalGnlDettePatient;
