		...
		<div id="divPersoMedicReport">
			...
			?>
					<tr style="text-align:center;">
						...
						<td>
						<?php
						$resultPresta=$connexion->prepare('SELECT *FROM prestations_'.$insurance.' p WHERE p.id_prestation=:prestaId');		
	...
	?>
		...
		<div id="divGnlBillReport" style="font-weight:normal;">
			...
			if($mois<0)
			{
							...
							{	
								if(array_key_exists($billArray[$b]['id_bill'], $consuArray))
								{
									if($consuArray[$billArray[$b]['id_bill']]['prixtypeconsult']!=0 AND $consuArray[$billArray[$b]['id_bill']]['prixrembou']!=0)
									{
										...
										$prixconsultCCO=$consuArray[$billArray[$b]['id_bill']]['prixtypeconsultCCO'] - $prixPrestaRembou;

									}else{
										$prixconsult=$consuArray[$billArray[$b]['id_bill']]['prixtypeconsult'];
										$prixconsultCCO=$consuArray[$billArray[$b]['id_bill']]['prixtypeconsultCCO'];
									...
									{	
										...
										$TotalTypeConsuCCO=$TotalTypeConsuCCO+$prixconsultCCO;
                ...
                $TotalTypeConsuBalance = ($TotalTypeConsuCCO - $TotalTypeConsu) + ($TotalTypeConsuPatient + $TotalTypeConsuInsu);
						...
						if($comptMedSurge!=0)
						{
							if(array_key_exists($billArray[$b]['id_bill'], $surgeArray))
							{
								for($n=0;$n<sizeof($surgeArray[$billArray[$b]['id_bill']]);$n++)
								{
									...
									$prixprestationCCO=$surgeArray[$billArray[$b]['id_bill']][$n]['prixprestationSurgeCCO'];
									...
									$prixautrePrestaSCCO=$surgeArray[$billArray[$b]['id_bill']][$n]['prixautrePrestaSCCO'];
									...
									if($prixprestation!=0 AND $prixrembouSurge!=0)
									{
										...
										$prixsurgeCCO=$prixprestationCCO - $prixPrestaRembou;
										...
										if($prixautrePrestaS!=0 AND $prixrembouSurge!=0)
										{
											...
											$prixsurgeCCO=$prixautrePrestaSCCO - $prixPrestaRembou;

										}else{
											if($prixprestation!=0 AND $prixrembouSurge ==0)
											{	
												$prixsurge=$prixprestation;
												$prixsurgeCCO=$prixprestationCCO;
											}else{
												$prixsurge=$prixautrePrestaS;
												$prixsurgeCCO=$prixautrePrestaSCCO;
						...
						if($comptMedInf!=0)
						{
							if(array_key_exists($billArray[$b]['id_bill'], $infArray))
							{
								for($n=0;$n<sizeof($infArray[$billArray[$b]['id_bill']]);$n++)
								{
									...
									$prixprestationCCO=$infArray[$billArray[$b]['id_bill']][$n]['prixprestationCCO'];
									...
									$prixautrePrestaMCCO=$infArray[$billArray[$b]['id_bill']][$n]['prixautrePrestaMCCO'];
									...
									if($prixprestation!=0 AND $prixrembouInf!=0)
									{
										...
										$prixinfCCO=$prixprestationCCO - $prixPrestaRembou;
										...
										if($prixautrePrestaM!=0 AND $prixrembouInf!=0)
										{
											...
											$prixinfCCO=$prixautrePrestaMCCO - $prixPrestaRembou;

										}else{
											if($prixprestation!=0 AND $prixrembouInf ==0)
											{
												$prixinf=$prixprestation;
												$prixinfCCO=$prixprestationCCO;
											}else{
												$prixinf=$prixautrePrestaM;
												$prixinfCCO=$prixautrePrestaMCCO;
						...
						if($comptMedLabo!=0)
						{
							...
							if(array_key_exists($billArray[$b]['id_bill'], $laboArray))
							{
								for($l=0;$l<sizeof($laboArray[$billArray[$b]['id_bill']]);$l++)
								{
									...
									$prixprestationExaCCO=$laboArray[$billArray[$b]['id_bill']][$l]['prixprestationExaCCO'];
									...
									$prixautreExamenCCO=$laboArray[$billArray[$b]['id_bill']][$l]['prixautreExamenCCO'];
									...
									if($prixprestationExa!=0 AND $prixrembouLabo!=0)
									{
										...
										$prixlaboCCO=$prixprestationExaCCO - $prixPrestaRembou;
										...
										if($prixautreExamen!=0 AND $prixrembouLabo!=0)
										{
											...
											$prixlaboCCO=$prixautreExamenCCO - $prixPrestaRembou;

										}else{
											if($prixprestationExa!=0 AND $prixrembouLabo ==0)
											{	
												$prixlabo=$prixprestationExa;
												$prixlaboCCO=$prixprestationExaCCO;
											}else{
												$prixlabo=$prixautreExamen;
												$prixlaboCCO=$prixautreExamenCCO;
						...
						if($comptMedRadio!=0)
						{
							if(array_key_exists($billArray[$b]['id_bill'], $radioArray))
							{
								for($r=0;$r<sizeof($radioArray[$billArray[$b]['id_bill']]);$r++)
								{
									...
									$prixprestationRadioCCO=$radioArray[$billArray[$b]['id_bill']][$r]['prixprestationRadioCCO'];
									...
									$prixautreRadioCCO=$radioArray[$billArray[$b]['id_bill']][$r]['prixautreRadioCCO'];
									...
									if($prixprestationRadio!=0 AND $prixrembouRadio!=0)
									{
										...
										$prixradioCCO=$prixprestationRadioCCO - $prixPrestaRembou;
										...
										if($prixautreRadio!=0 AND $prixrembouRadio!=0)
										{
											...
											$prixradioCCO=$prixautreRadioCCO - $prixPrestaRembou;

										}else{
											if($prixprestationRadio!=0 AND $prixrembouRadio ==0)
											{	
												$prixradio=$prixprestationRadio;
												$prixradioCCO=$prixprestationRadioCCO;
											}else{
												$prixradio=$prixautreRadio;
												$prixradioCCO=$prixautreRadioCCO;
						...
						if($comptMedKine!=0)
						{
							if(array_key_exists($billArray[$b]['id_bill'], $kineArray))
							{
								for($r=0;$r<sizeof($kineArray[$billArray[$b]['id_bill']]);$r++)
								{
									...
									$prixprestationKineCCO=$kineArray[$billArray[$b]['id_bill']][$r]['prixprestationKineCCO'];
									...
									$prixautreKineCCO=$kineArray[$billArray[$b]['id_bill']][$r]['prixautrePrestaKCCO'];
									...
									if($prixprestationKine!=0 AND $prixrembouKine!=0)
									{
										...
										$prixkineCCO=$prixprestationKineCCO - $prixPrestaRembou;
										...
										if($prixautreKine!=0 AND $prixrembouKine!=0)
										{
											...
											$prixkineCCO=$prixautreKineCCO - $prixPrestaRembou;

										}else{
											if($prixprestationKine!=0 AND $prixrembouKine ==0)
											{
												$prixkine=$prixprestationKine;
												$prixkineCCO=$prixprestationKineCCO;
											}else{
												$prixkine=$prixautreKine;
												$prixkineCCO=$prixautreKineCCO;
						...
						if($comptMedOrtho!=0)
						{
							if(array_key_exists($billArray[$b]['id_bill'], $orthoArray))
							{
								for($r=0;$r<sizeof($orthoArray[$billArray[$b]['id_bill']]);$r++)
								{
									...
									$prixprestationOrthoCCO=$orthoArray[$billArray[$b]['id_bill']][$r]['prixprestationOrthoCCO'];
									...
									$prixautreOrthoCCO=$orthoArray[$billArray[$b]['id_bill']][$r]['prixautrePrestaOCCO'];
									...
									if($prixprestationOrtho!=0 AND $prixrembouOrtho!=0)
									{
										...
										$prixorthoCCO=$prixprestationOrthoCCO - $prixPrestaRembou;
										...
										if($prixautreOrtho!=0 AND $prixrembouOrtho!=0)
										{
											...
											$prixorthoCCO=$prixautreOrthoCCO - $prixPrestaRembou;

										}else{
											if($prixprestationOrtho!=0 AND $prixrembouOrtho ==0)
											{
												$prixortho=$prixprestationOrtho;
												$prixorthoCCO=$prixprestationOrthoCCO;
											}else{
												$prixortho=$prixautreOrtho;
												$prixorthoCCO=$prixautreOrthoCCO;
						...
						if($comptMedConsom!=0)
						{
							if(array_key_exists($billArray[$b]['id_bill'], $consomArray))
							{
								for($c=0;$c<sizeof($consomArray[$billArray[$b]['id_bill']]);$c++)
								{
									...
									$prixprestationConsomCCO=$consomArray[$billArray[$b]['id_bill']][$c]['prixprestationConsomCCO'];
									...
									$prixautreConsomCCO=$consomArray[$billArray[$b]['id_bill']][$c]['prixautreConsomCCO'];
									...
									if($prixprestationConsom!=0 AND $prixrembouConsom!=0)
									{
										...
										$prixconsomCCO=($prixprestationConsomCCO * $qteConsom) - $prixPrestaRembou;
										...
										if($prixautreConsom!=0 AND $prixrembouConsom!=0)
										{
											...
											$prixconsomCCO=($prixautreConsomCCO * $qteConsom) - $prixPrestaRembou;

										}else{
											if($prixprestationConsom!=0 AND $prixrembouConsom ==0)
											{	
												$prixconsom=$prixprestationConsom * $qteConsom;
												$prixconsomCCO=$prixprestationConsomCCO * $qteConsom;
											}else{
												$prixconsom=$prixautreConsom * $qteConsom;
												$prixconsomCCO=$prixautreConsomCCO * $qteConsom;
						...
						if($comptMedMedoc!=0)
						{
							if(array_key_exists($billArray[$b]['id_bill'], $medocArray))
							{
								for($m=0;$m<sizeof($medocArray[$billArray[$b]['id_bill']]);$m++)
								{
									...
									$prixprestationMedocCCO=$medocArray[$billArray[$b]['id_bill']][$m]['prixprestationMedocCCO'];
									...
									$prixautreMedocCCO=$medocArray[$billArray[$b]['id_bill']][$m]['prixautreMedocCCO'];
									...
									if($prixprestationMedoc!=0 AND $prixrembouMedoc!=0)
									{
										...
										$prixmedocCCO=($prixprestationMedocCCO * $qteMedoc) - $prixPrestaRembou;
										...
										if($prixautreMedoc!=0 AND $prixrembouMedoc!=0)
										{
											...
											$prixmedocCCO=($prixautreMedocCCO * $qteMedoc) - $prixPrestaRembou;

										}else{
											if($prixprestationMedoc!=0 AND $prixrembouMedoc ==0)
											{	
												$prixmedoc=$prixprestationMedoc * $qteMedoc;
												$prixmedocCCO=$prixprestationMedocCCO * $qteMedoc;
											}else{
												$prixmedoc=$prixautreMedoc * $qteMedoc;
												$prixmedocCCO=$prixautreMedocCCO * $qteMedoc;
                                    ...
                                    if($comptServices!=0)
                                    {
                                        if(array_key_exists($billArray[$b]['id_bill'], $serviceArray))
                                        {
                                            ...
                                            for($s=0;$s<sizeof($serviceArray[$billArray[$b]['id_bill']]);$s++)
                                            {
                                                ...
                                                $prixprestationConsuCCO=$serviceArray[$billArray[$b]['id_bill']][$s]['prixprestationConsuCCO'];
                                                ...
                                                $prixautreConsuCCO=$serviceArray[$billArray[$b]['id_bill']][$s]['prixautreConsuCCO'];
                                                ...
                                                if($prixprestationConsu!=0 AND $prixrembouConsu!=0)
                                                {
                                                    ...
                                                    $prixconsuCCO=$prixprestationConsuCCO - $prixPrestaRembou;
                                                    ...
                                                    if($prixautreConsu!=0 AND $prixrembouConsu!=0)
                                                    {
                                                        ...
                                                        $prixconsuCCO=$prixautreConsuCCO - $prixPrestaRembou;

                                                    }else{
                                                        if($prixprestationConsu!=0 AND $prixrembouConsu ==0)
                                                        {
                                                            $prixconsu=$prixprestationConsu;
                                                            $prixconsuCCO=$prixprestationConsuCCO;
                                                        }else{
                                                            $prixconsu=$prixautreConsu;
                                                            $prixconsuCCO=$prixautreConsuCCO;
