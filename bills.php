...
?>
	<div style="margin: 10px auto auto; width:95%; border: 1px solid #ccc; background:#fff; padding:2px; border-radius:3px; font-size:70%;font-family:consolas;">
			...
			<table>
				<tr>
					...
					<td style="text-align:left;width:80%">
						<span style="border-top:none;border-bottom:2px solid #ccc; font-size:150%; font-weight:900"></span>
	...
	<div class="account-container" style="margin: 20px auto auto; width:95%; border: 1px solid #ccc; background:#fff; padding:5px; border-radius:3px; font-size:80%;font-family:consolas;<?php if(isset($_GET['smallsize'])){ echo 'display:none;';}?>">
<?php
$barcode = '
...
<?php
	...
	<table style="width:100%; margin-bottom:-5px">
		<tr>
			...
			<h2 style="font-size:150%; font-weight:600;">Bill n° <?php echo $numbill;?> <?php if($dettes!=NULL){ echo '<span style="font-size:150%; font-weight:600;color:red;" class="buttonBill">Indebted</span>';}?></h2>

			</td>

			<td style="text-align:right;width:33%;">

				<form method="post" action="bills.php?num=<?php echo $_GET['num'];?>&cashier=<?php echo $_SESSION['codeCash'];?><?php if(isset($dateconsu)){echo "&dateconsu=".$dateconsu;};?><?php if(isset($_GET['idconsu'])){ echo '&idconsu='.$_GET['idconsu'];}?><?php if(isset($_GET['idmed'])){ echo '&idmed='.$_GET['idmed'];}?><?php if(isset($_GET['datefacture'])){ echo '&datefacture='.$_GET['datefacture'];}?><?php if(isset($_GET['idtypeconsu'])){ echo '&idtypeconsu='.$_GET['idtypeconsu'];}?><?php if(isset($_GET['idassu'])){ echo '&idassu='.$_GET['idassu'];}?><?php if(isset($idBilling)){ echo '&idbill='.$idBilling;}?><?php if(isset($_GET['dettelist'])){ echo '&dettelist='.$_GET['dettelist'];}?>&finishbtn=ok" enctype="multipart/form-data" class="buttonBill">
