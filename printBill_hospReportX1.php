	...
	?>
			<table class="printPreview tablesorter3" cellspacing="0" style="margin:0 auto 25px;width:90%;"> 
				<thead> 
					<tr>
						...
						<th style="width:8%;text-align:center;">Price/day ra</th>
				...
				while($ligneHosp=$resultHosp->fetch())
				{
					...
					if($comptPresta!=0)
					{
						...
						?>
                            ...
                            <td style="text-align:center;"><?php echo $ligneHosp->prixroomCCO;?><span style="font-size:70%; font-weight:normal;">Rwf</span></td>
			...
			<table class="printPreview" cellspacing="0" style="margin:auto auto 5px;">
				<thead> 
					...
					<tr>
                        ...
                        <th style="width:10%;background:rgba(0, 0, 0, 0.05)">P/U CCO</th>
                        ...
                        <th style="width:5%;background:rgba(0, 0, 0, 0.05)"></th>
					</tr> 
				</thead> 
			...
			$TotaluapPricePayed=0;
				...
				while($ligneMedSurge=$resultMedSurge->fetch())
				{
					...
					?>
					<tr style="text-align:center;<?php if($ligneMedSurge->id_factureMedSurge!="" AND $ligneMedSurge->id_factureMedSurge!=0){ echo 'color:rgba(0, 0, 0, 0.5);';}?>">
        ...
        if($ligneMedSurge->id_factureMedSurge=="" OR $ligneMedSurge->id_factureMedSurge==0)
        {
			...
			$TotaluapPricePayed=0;
				...
				while($ligneMedInf=$resultMedInf->fetch())
				{
					...
					?>
					<tr style="text-align:center;<?php if($ligneMedInf->id_factureMedInf!="" AND $ligneMedInf->id_factureMedInf!=0){ echo 'color:rgba(0, 0, 0, 0.5);';}?>">
			...
			$TotaluapPricePayed=0;
				...
				while($ligneMedLabo=$resultMedLabo->fetch())
				{
					...
					{
					?>
					<tr style="text-align:center;<?php if($ligneMedLabo->id_factureMedLabo!="" AND $ligneMedLabo->id_factureMedLabo!=0){ echo 'color:rgba(0, 0, 0, 0.5);';}?>">
		...
		<?php
			...
			$TotaluapPricePayed=0;
				...
				while($ligneMedRadio=$resultMedRadio->fetch())
				{
					...
					{
					?>
					<tr style="text-align:center;<?php if($ligneMedRadio->id_factureMedRadio!="" AND $ligneMedRadio->id_factureMedRadio!=0){ echo 'color:rgba(0, 0, 0, 0.5);';}?>">
                ...
                <table class="printPreview" cellspacing="0" style="margin:auto auto 5px;">
                    ...
                    while($ligneMedKine=$resultMedKine->fetch())
                    {
                        ...
                        if($lignePresta=$resultPresta->fetch())
                        {
                            ...
                            ?>
                            <tr style="text-align:center;<?php if($ligneMedKine->id_factureMedKine!="" AND $ligneMedKine->id_factureMedKine!=0){ echo 'color:rgba(0, 0, 0, 0.5);';}?>">
        ...
        if($ligneMedKine->id_factureMedKine=="" OR $ligneMedKine->id_factureMedKine==0)
        {
			...
			$TotaluapPricePayed=0;
					...
					while($ligneMedConsom=$resultMedConsom->fetch())
					{
						...
						{
						?>
						<tr style="text-align:center;<?php if($ligneMedConsom->id_factureMedConsom!="" AND $ligneMedConsom->id_factureMedConsom!=0){ echo 'color:rgba(0, 0, 0, 0.5);';}?>">
			...
			$TotaluapPricePayed=0;
					...
					{
					?>
						<tr style="text-align:center;<?php if($ligneMedMedoc->id_factureMedMedoc!="" AND $ligneMedMedoc->id_factureMedMedoc!=0){ echo 'color:rgba(0, 0, 0, 0.5);';}?>">
                ...
                <table class="printPreview" cellspacing="0" style="margin:auto auto 5px;">
                    ...
                    while($ligneMedOrtho=$resultMedOrtho->fetch())
                    {
                        ...
                        if($lignePresta=$resultPresta->fetch())
                        {
                            ...
                            ?>
                            <tr style="text-align:center;<?php if($ligneMedOrtho->id_factureMedOrtho!="" AND $ligneMedOrtho->id_factureMedOrtho!=0){ echo 'color:rgba(0, 0, 0, 0.5);';}?>">
            ...
            if($comptMedConsult != 0)
            {
                ...
                <table class="printPreview" cellspacing="0" style="margin:auto auto 5px;">
                    ...
                    while($ligneMedConsult=$resultMedConsult->fetch())
                    {
                        ...
                        {
                            ?>
                            <tr style="text-align:center;<?php if($ligneMedConsult->id_factureMedConsu !="" AND $ligneMedConsult->id_factureMedConsu !=0){ echo 'color:rgba(0, 0, 0, 0.5);';}?>">
