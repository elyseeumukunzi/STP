...
?>
		...
		?>
			...
			<?php
				...
				{				
					...
					echo '<script text="text/javascript">document.location.href="other_report.php?med='.$_GET['med'].'&dailydateperso='.$_GET['dailydateperso'].'&clinic='.$_GET['clinic'].'&docVisit='.$_GET['docVisit'].'&stringResult='.$_GET['stringResult'].'&divPersoMedicReport=ok&createReportPdf=ok&createRN=0"</script>';
				}			
			}
		...
		?>
			...
			<?php
				...
				{				
					...
					echo '<script text="text/javascript">document.location.href="other_report.php?med='.$_GET['med'].'&dailydateperso='.$_GET['dailydateperso'].'&clinic='.$_GET['clinic'].'&docVisit='.$_GET['docVisit'].'&stringResult='.$_GET['stringResult'].'&divPersoBillReport=ok&createReportPdf=ok&createRN=0"</script>';
				}
			}
		}
		if (isset($_GET['hospi'])) {
		...
		?>
			...
			<?php
				...
				{				
					...
					echo '<script text="text/javascript">document.location.href="other_report.php?med='.$_GET['med'].'&dailydateperso='.$_GET['dailydateperso'].'&hospi='.$_GET['hospi'].'&docVisit='.$_GET['docVisit'].'&stringResult='.$_GET['stringResult'].'&divPersoMedicReport=ok&createReportPdf=ok&createRN=0"</script>';
				}			
			}
		...
		?>
							...
							?>
								...
								<tbody>
									...
									<?php
										...
										$insupercent_hospRad = $ligneMedRadio->insupercent_hospRad;
			...
			<?php
				...
				{				
					...
					echo '<script text="text/javascript">document.location.href="other_report.php?med='.$_GET['med'].'&dailydateperso='.$_GET['dailydateperso'].'&hospi='.$_GET['hospi'].'&docVisit='.$_GET['docVisit'].'&stringResult='.$_GET['stringResult'].'&divPersoBillReport=ok&createReportPdf=ok&createRN=0"</script>';
				}
			}
		}
	...
	?>
		...
		<table cellpadding=3 style="background:#fff; margin:auto auto 10px auto; padding: 10px; width:100%;">
			...
			<tr>
				...
				<td style="text-align:left;">
					<h2 style="font-size:150%; font-weight:600;"><?php echo $stringResult;?> General Other Report #<?php echo $sn;?></h2>
				</td>
				
				<td style="text-align:right">
					
					<form method="post" action="other_report.php?othersacte=<?php echo $_GET['othersacte'];?>&dailydateperso=<?php echo $dailydateperso;?>&docVisit=<?php echo $docVisit;?><?php if(isset($_GET['divPersoMedicReport'])){echo '&divPersoMedicReport=ok';}if(isset($_GET['divPersoBillReport'])){echo '&divPersoBillReport=ok';}?>&stringResult=<?php echo $_GET['stringResult'];?>&createReportPdf=ok&createRN=<?php echo $createRN;?>" enctype="multipart/form-data" class="buttonBill">
				...
				<td style="text-align:<?php if(isset($_SESSION['codeC'])){ echo 'right';}else{ echo 'left';}?>">
						...
						<a href="report.php?othersacte=<?php echo $_GET['othersacte'];?>&coordi=<?php echo $_SESSION['id'];?>&report=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="buttonBill">
							<button class="btn-large-inversed" style="width:150px;"><i class="fa fa-ban fa-lg fa-fw"></i> <?php echo getString(140);?></button>
						</a>
	...
	?>
		<div id="divPersoMedicReport">
			...
			$resultConsult=$connexion->query('SELECT *FROM consultations c WHERE c.id_uM=11 AND c.done=1 '.$dailydateperso.' ORDER BY c.id_uM');		
			/* $resultConsult->execute(array(
			'med'=>$idDoc 
			)); */
		...
		<?php
			...
			{				
				...
				echo '<script text="text/javascript">document.location.href="other_report.php?othersacte='.$_GET['othersacte'].'&dailydateperso='.$_GET['dailydateperso'].'&docVisit='.$_GET['docVisit'].'&stringResult='.$_GET['stringResult'].'&divPersoMedicReport=ok&createReportPdf=ok&createRN=0"</script>';
			}			
		}
	...
	?>
			<div id="divPersoBillReport">
				...
				$resultConsult=$connexion->prepare('SELECT *FROM consultations c WHERE c.id_uM=11 AND c.id_factureConsult IS NOT NULL AND c.done=1 '.$dailydateperso.' ORDER BY c.dateconsu ASC');		
				/*$resultConsult->execute(array(
				'med'=>$idDoc
				));*/
			...
			<?php
				...
				{				
					...
					echo '<script text="text/javascript">document.location.href="other_report.php?med='.$_GET['med'].'&dailydateperso='.$_GET['dailydateperso'].'&docVisit='.$_GET['docVisit'].'&stringResult='.$_GET['stringResult'].'&divPersoBillReport=ok&createReportPdf=ok&createRN=0"</script>';
				}
			}
	...
	?>
			<div id="divPersoBillReport">
				...
				$resultConsult=$connexion->query('SELECT *FROM consultations c WHERE c.id_uM=11 AND c.done=1 AND c.id_factureConsult IS NOT NULL '.$dailydateperso.' ORDER BY c.dateconsu ASC');		
				/*$resultConsult->execute(array(
				'med'=>$idDoc
				));*/
							...
							<tbody>
								...
								<tr>
									...
									if($lignePresta=$resultPresta->fetch())
									{
										...
										echo '<td style="border-left:1px solid #eee;">'.$ligneMedoc->prixprestationMedoc.'</td>';
										$prixmedoc=$ligneMedoc->prixprestationMedoc;						
										...
										$prixmedoc=$ligneMedoc->prixautreMedoc;						
															
										$meddoc .= ''.$ligneMedoc->prixautreMedoc.', ';
									}
									?>
								</tr>
								<?php
			...
			<?php
				...
				{				
					...
					if (isset($_GET['othersacte'])) {
						echo '<script text="text/javascript">document.location.href="other_report.php?othersacte='.$_GET['othersacte'].'&dailydateperso='.$_GET['dailydateperso'].'&docVisit='.$_GET['docVisit'].'&stringResult='.$_GET['stringResult'].'&divPersoBillReport=ok&createReportPdf=ok&createRN=0"</script>';
					}else{
						echo '<script text="text/javascript">document.location.href="other_report.php?med='.$_GET['med'].'&dailydateperso='.$_GET['dailydateperso'].'&docVisit='.$_GET['docVisit'].'&stringResult='.$_GET['stringResult'].'&divPersoBillReport=ok&createReportPdf=ok&createRN=0"</script>';
					}
				}
