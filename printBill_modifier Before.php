...
<?php
        ...
        if(isset($_POST['idprestaSurge']))
        {
            ...
            for($i=0;$i<sizeof($addSurge);$i++)
            {
                ...
                if($comptPresta!=0)
                {
                    $updatepercent=$connexion->query('UPDATE med_surge ms SET ms.insupercentSurge='.$addSurge[$i].',ms.prixprestationSurge='.$prixms[$i].',ms.discountpercentSurge='.$discountpercentSurge.',ms.prixautrePrestaS=0,ms.id_factureMedSurge='.$_GET['idbill'].' WHERE ms.id_medsurge='.$idms[$i].'');
                    ...
                    if($ligne=$results->fetch())
                    {
                        $updatepercent=$connexion->query('UPDATE med_surge ms SET ms.insupercentSurge='.$addSurge[$i].',ms.prixprestationSurge=0,ms.prixautrePrestaS='.$prixms[$i].',ms.discountpercentSurge='.$discountpercentSurge.',ms.id_factureMedSurge='.$_GET['idbill'].' WHERE ms.id_medsurge='.$idms[$i].'');
        ...
        if(isset($_POST['idprestaInf']))
        {
            ...
            for($i=0;$i<sizeof($addInf);$i++)
            {
                ...
                if($comptPresta!=0)
                {
                    $updatepercent=$connexion->query('UPDATE med_inf mi SET mi.insupercentInf='.$addInf[$i].',mi.prixprestation='.$prixmi[$i].',mi.discountpercentInf='.$discountpercentInf.',mi.prixautrePrestaM=0,mi.id_factureMedInf='.$_GET['idbill'].' WHERE mi.id_medinf='.$idmi[$i].'');
                    ...
                    if($ligne=$results->fetch())
                    {
                        $updatepercent=$connexion->query('UPDATE med_inf mi SET mi.insupercentInf='.$addInf[$i].',mi.prixprestation=0,mi.prixautrePrestaM='.$prixmi[$i].',mi.discountpercentInf='.$discountpercentInf.',mi.id_factureMedInf='.$_GET['idbill'].' WHERE mi.id_medinf='.$idmi[$i].'');
        ...
        if(isset($_POST['idprestaLab']))
        {
            ...
            for($i=0;$i<sizeof($addLab);$i++)
            {
                ...
                if($comptPresta!=0)
                {
                    $updatepercent=$connexion->query('UPDATE med_labo ml SET ml.insupercentLab='.$addLab[$i].',ml.prixprestationExa='.$prixml[$i].',ml.discountpercentLab='.$discountpercentLab.',ml.prixautreExamen=0,ml.id_factureMedLabo='.$_GET['idbill'].' WHERE ml.id_medlabo='.$idml[$i].'');
                    ...
                    if($ligne=$results->fetch())
                    {
                        $updatepercent=$connexion->query('UPDATE med_labo ml SET ml.insupercentLab='.$addLab[$i].'ml.discountpercentLab='.$discountpercentLab.',ml.prixprestationExa=0,ml.prixautreExamen='.$prixml[$i].',ml.id_factureMedLabo='.$_GET['idbill'].' WHERE ml.id_medlabo='.$idml[$i].'');
        ...
        if(isset($_POST['idprestaRad']))
        {
            ...
            for($i=0;$i<sizeof($addRad);$i++)
            {
                ...
                if($comptPresta!=0)
                {
                    $updatepercent=$connexion->query('UPDATE med_radio mr SET mr.insupercentRad='.$addRad[$i].',mr.prixprestationRadio='.$prixmr[$i].',mr.discountpercentRadio='.$discountpercentRadio.',mr.prixautreRadio=0,,mr.id_factureMedRadio='.$_GET['idbill'].' WHERE mr.id_medradio='.$idmr[$i].'');
                    ...
                    if($ligne=$results->fetch())
                    {
                        $updatepercent=$connexion->query('UPDATE med_radio mr SET mr.insupercentRad='.$addRad[$i].',mr.prixprestationRadio=0,mr.prixautreRadio='.$prixmr[$i].',mr.discountpercentRadio='.$discountpercentRadio.',mr.id_factureMedRadio='.$_GET['idbill'].' WHERE mr.id_medradio='.$idmr[$i].'');
        ...
        if(isset($_POST['idprestaKine']))
        {
            ...
            for($i=0;$i<sizeof($addKine);$i++)
            {
                ...
                if($comptPresta!=0)
                {
                    $updatepercent=$connexion->query('UPDATE med_kine mk SET mk.insupercentKine='.$addKine[$i].',mk.prixprestationKine='.$prixmk[$i].',mk.discountpercentkine='.$discountpercentkine.',mk.prixautrePrestaK=0,mk.id_factureMedKine='.$_GET['idbill'].' WHERE mk.id_medkine='.$idmk[$i].'');
                    ...
                    if($ligne=$results->fetch())
                    {
                        $updatepercent=$connexion->query('UPDATE med_kine mk SET mk.insupercentKine='.$addKine[$i].',mk.prixprestationKine=0,mk.prixautrePrestaK='.$prixmk[$i].',mk.discountpercentkine='.$discountpercentkine.',mk.id_factureMedKine='.$_GET['idbill'].' WHERE mk.id_medkine='.$idmk[$i].'');
        ...
        if(isset($_POST['idprestaOrtho']))
        {
            ...
            for($i=0;$i<sizeof($addOrtho);$i++)
            {
                ...
                if($comptPresta!=0)
                {
                    $updatepercent=$connexion->query('UPDATE med_ortho mo SET mo.insupercentOrtho='.$addOrtho[$i].',mo.prixprestationOrtho='.$prixmo[$i].',mo.discountpercentOrtho='.$discountpercentOrtho.',mo.prixautrePrestaO=0,mo.id_factureMedOrtho='.$_GET['idbill'].' WHERE mo.id_medortho='.$idmo[$i].'');
                    ...
                    if($ligne=$results->fetch())
                    {
                        $updatepercent=$connexion->query('UPDATE med_ortho mo SET mo.insupercentOrtho='.$addOrtho[$i].',mo.prixprestationOrtho=0,mo.prixautrePrestaO='.$prixmo[$i].',mo.discountpercentOrtho='.$discountpercentOrtho.',mo.id_factureMedOrtho='.$_GET['idbill'].' WHERE mo.id_medortho='.$idmo[$i].'');
        ...
        if(isset($_POST['idprestaConsom']))
        {
            ...
            for($i=0;$i<sizeof($addConsom);$i++)
            {
                ...
                if($comptPresta!=0)
                {
                    $updatepercent=$connexion->query('UPDATE med_consom mco SET mco.insupercentConsom='.$addConsom[$i].',mco.prixprestationConsom='.$prixmco[$i].',mco.discountpercentConsom='.$discountpercentConsom.',mco.prixautreConsom=0,mco.qteConsom='.$qteConsom[$i].',mco.id_factureMedConsom='.$_GET['idbill'].' WHERE mco.id_medconsom='.$idmco[$i].'');
                    ...
                    if($ligne=$results->fetch())
                    {
                        $updatepercent=$connexion->query('UPDATE med_consom mco SET mco.insupercentConsom='.$addConsom[$i].',mco.prixprestationConsom=0,mco.prixautreConsom='.$prixmco[$i].',mco.discountpercentConsom='.$discountpercentConsom.',mco.qteConsom='.$qteConsom[$i].',mco.id_factureMedConsom='.$_GET['idbill'].' WHERE mco.id_medconsom='.$idmco[$i].'');
                    }
                }
            }
        }
        ...
        if(isset($_POST['idprestaMedoc']))
        {
            ...
            for($i=0;$i<sizeof($addMedoc);$i++)
            {
                ...
                if($comptPresta!=0)
                {
                    $updatepercent=$connexion->query('UPDATE med_medoc mdo SET mdo.insupercentMedoc='.$addMedoc[$i].',mdo.prixprestationMedoc='.$prixmdo[$i].',mdo.discountpercentMedoc='.$discountpercentMedoc.',mdo.prixautreMedoc=0,mdo.qteMedoc='.$qteMedoc[$i].',mdo.id_factureMedMedoc='.$_GET['idbill'].' WHERE mdo.id_medmedoc='.$idmdo[$i].'');
                    ...
                    if($ligne=$results->fetch())
                    {
                        $updatepercent=$connexion->query('UPDATE med_medoc mdo SET mdo.insupercentMedoc='.$addMedoc[$i].',mdo.prixprestationMedoc=0,mdo.prixautreMedoc='.$prixmdo[$i].',mdo.discountpercentMedoc='.$discountpercentMedoc.',mdo.qteMedoc='.$qteMedoc[$i].',mdo.id_factureMedMedoc='.$_GET['idbill'].' WHERE mdo.id_medmedoc='.$idmdo[$i].'');
