	...
	<table style="width:50%; margin-top:20px;font-size:15px;" align="center">		
		...
		?>
			<div id="divPersoMedicReport">
				...
				$resultConsult=$connexion->query('SELECT *FROM patients_hosp ph WHERE ph.id_consuHosp!=0 AND '.$dailydateperso.' ORDER BY ph.dateSortie ASC');	
		...
		?>
			<div id="2010">
				...
				$resultConsult=$connexion->query('SELECT *FROM patients_hosp ph WHERE ph.id_consuHosp!=0  '.$dailydateperso.' ORDER BY ph.dateSortie ASC');	
