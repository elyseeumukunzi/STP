...
if($connected==true AND isset($_SESSION['id']))
{
	...
	$resultatsCoordi=$connexion->prepare('SELECT *FROM utilisateurs u, accountants acc WHERE u.id_u=acc.id_u and acc.id_u=:operation');
