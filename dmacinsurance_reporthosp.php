...
?>
	...
	?>
		<table cellpadding=3 style="width:100%; margin:5px auto auto;">
			...
			<tr>
				...
				<td style="text-align:right">
					...
					<a href="insurance_reporthosp.php?audit=<?php echo $_SESSION['id'];?>&nomassu=<?php echo $nomassu;?>&idassu=<?php echo $idassu;?>&insugnlreporthosp=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="buttonBill">
		...
		<div id="divGnlBillReport" style="font-weight:normal;">
			...
			$resultGnlBillReport=$connexion->prepare('SELECT *FROM patients_hosp ph WHERE nomassuranceHosp =:nomassu '.$dailydategnl.' ORDER BY dateSortie ASC');
