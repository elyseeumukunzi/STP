...
?>
	<div style="margin: 10px auto auto; width:95%; border: 1px solid #ccc; background:#fff; padding:2px; border-radius:3px; font-size:85%;font-family:consolas;">
...
$barcode = '
	...
	<table style="width:100%">
		...
		<tr>
			<td colspan=2 style="text-align:center;">
				<span style="text-align:center;background:#333;border-radius:40px;color:#eee;font-weight:400;padding:5px 50px">Powered by <font>MEDICAL FILE</font> , a product of Innovate Solutions Group Ltd. ©2022-'.date('Y').', All Rights Reserved.</span>
			</td>
		</tr>
