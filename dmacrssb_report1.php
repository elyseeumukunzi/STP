		...
		<div id="divGnlBillReport" style="font-weight:normal;">
			...
			if($comptBillReport!=0)
			{
				...
				$objPHPExcel->setActiveSheetIndex(0)
								...
								->setCellValue('N9', 'COST FOR OTHER HOSPITALISATION')
								->setCellValue('O9', 'COST FOR PROCEDURES AND MATERIALS')
								->setCellValue('P9', 'COST FOR OTHER CONSUMABLES')
								->setCellValue('Q9', 'COST FOR MEDICINES')
								->setCellValue('R9', 'TOTAL AMOUNT')
								->setCellValue('S9', 'TOTAL AMOUNT '.$_GET['nomassu'].'');
			...
			if($mois<0)
			{
				...
				$TotalGnlprocedMat=$TotalGnlMedConsu+$TotalGnlMedInf;
				...
				$TotalGnlPrice=$TotalGnlPrice + $TotalDayPrice;
					...
					$arrayGnlBillReport[$i][14]=$TotalprocedMat;
					
					// $arrayGnlBillReport[$i][15]=$medconsom;		
					$arrayGnlBillReport[$i][15]=$TotalMedConsom;
					...
					if($_GET['percent'] =="All")
					{
						$arrayGnlBillReport[$i][19]=$ligneGnlBillReport->billpercent.' %';
					}
				...
				?>
					<tr style="text-align:center;">
						...
						<td style="font-size: 13px; font-weight: bold;text-align:center;">
							0<span style="font-size:80%; font-weight:normal;">Rwf</span>
						</td>
			...
			<?php
				...
				$objPHPExcel->setActiveSheetIndex(0)
							...
							->setCellValue('N'.(10+$i).'', '0')
							->setCellValue('O'.(10+$i).'', ''.$TotalGnlprocedMat.'')
							->setCellValue('P'.(10+$i).'', ''.$TotalGnlMedConsom.'')
