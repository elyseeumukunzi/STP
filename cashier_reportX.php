            ...
            <table cellpadding=3 style="background:#fff; margin:auto auto 10px auto; padding: 10px; width:100%;">
                ...
                <tr>
                    ...
                    <td style="text-align:left;">
                        <h2 style="font-size:150%; font-weight:600;"><?php echo $stringResult;?>ddd<?php if(isset($_GET['divPersoBillReport'])){ echo ' Cashier Report #';} if(isset($_GET['divPersoBillReportHosp'])){ echo ' Cashier Hospital Report #';}?><?php echo $sn;?></h2>
                    </td>
            ...
            if(isset($_GET['divPersoBillReport']))
            {
                ...
                <div id="divPersoBillReport">
					...
					?>
						...
						if($mois<0)
						{
							...
							?>
                                ...
                                <?php
                    $selectExpe=$connexion->prepare("SELECT * FROM expenses WHERE expedate=:expedate");
                    $selectExpe->execute(['expedate'=>$annee]);
                    ...
                    <td style="font-size: 30px; font-weight: bold;">
                            <?php                       
                                echo $Totalbalaance=$TotalGnlPricePatientBalance-$expensestotal;
                            ?><span style="font-size:80%; font-weight:normal;">Rwf</span>
                        </td>
                    </tr>
							</tbody>
