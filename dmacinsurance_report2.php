	...
	?>
		<table cellpadding=3 style="width:100%; margin:5px auto auto;">
			...
			<tr>
				...
				<td style="text-align:right">
					...
					<a href="<?php if(!isset($_SESSION['codeC']) AND $_SESSION['dataM']!=NULL){ echo 'insurance_reportDataM.php';}else{ echo 'insurance_report.php';}?>?audit=<?php echo $_SESSION['id'];?>&nomassu=<?php echo $nomassu;?>&idassu=<?php echo $idassu;?>&insugnlreport=ok<?php if(isset($_GET['english'])){ echo '&english='.$_GET['english'];}else{if(isset($_GET['francais'])){ echo '&francais='.$_GET['francais'];}}?>" class="buttonBill">
						<button class="btn-large-inversed" style="width:150px;"><i class="fa fa-ban fa-lg fa-fw"></i> <?php echo getString(140);?></button>
					</a>
		...
		<div id="divGnlBillReport" style="font-weight:normal;">
			...
			if($mois<0)
			{
				...
				?>
					<tr style="text-align:center;">
						<td colspan=<?php if($_GET['idassu']==1){ echo '10';}else{ echo '11';}?>></td>
