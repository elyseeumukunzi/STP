	...
	<table style="width:100%; margin-bottom:-10px;padding-top: 10px;padding-bottom: 10px;">
		<tr>
			...
			<td style="text-align:right;width:auto;">
				...
				<form method="post" action="UnBilledView.php?audit=<?php echo $_SESSION['id'];?>&cash=<?php echo $_GET['cash']; ?>&stringResult=<?php echo $_GET['stringResult']; ?>&id_uC=<?php echo $_GET['id_uC']; ?>&dailydateperso=<?php echo $_GET['dailydateperso'];?>&divGnlUnbilledReport=ok&cashierUnBilledbill=ok&paVisit=<?php echo $_GET['paVisit'];?>&idconsu=<?php echo $_GET['idconsu'];?>&num=<?php echo $_GET['num'];?>&printUnbilled=ok" enctype="multipart/form-data" class="buttonBill">
			...
			<td style="text-align:left;" class="buttonBill">
				<a href="UnBilled.php?audit=<?php echo $_SESSION['id'];?>&cash=<?php echo $_GET['cash']; ?>&stringResult=<?php echo $_GET['stringResult']; ?>&id_uC=<?php echo $_GET['id_uC']; ?>&dailydateperso=<?php echo $_GET['dailydateperso'];?>&divGnlUnbilledReport=ok&cashierUnBilledbill=ok&paVisit=<?php echo $_GET['paVisit'];?>" id="finishbtn" style="margin:30px;" class="btn-large-inversed flashing">
