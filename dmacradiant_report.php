		...
		<div id="divGnlBillReport" style="font-weight:normal;">
			...
			if($comptBillReport!=0)
			{
				...
				$objPHPExcel->setActiveSheetIndex(0)
							...
							->setCellValue('D9', 'N° POLICE')
							->setCellValue('E9', 'N° DE LA CARTE D\'ASSURE')
							->setCellValue('F9', 'NOM & PRENOM DU MALADE')
							->setCellValue('G9', 'NOM & PRENOM DE L\'ASSUREUR PRINCIPAL')
							->setCellValue('H9', 'CONSULTATION')
							->setCellValue('I9', 'SERVICES')
							->setCellValue('J9', 'EXAMEN COMPL.')
							->setCellValue('K9', 'RADIOLOGIE')
							->setCellValue('L9', 'INFIRMERIE')
							->setCellValue('M9', 'CONSOMMABLES')
							->setCellValue('N9', 'MEDICAMENTS')
							->setCellValue('O9', 'MONTANT 100%')
							->setCellValue('P9', 'MONTANT '.$_GET['nomassu'].'');
			...
			<table style="width:100%" class="printPreview tablesorter3" cellspacing="0"> 
				...
				<thead>
					<tr>
						...
						<th style="border-right: 1px solid #bbb;text-align:center;">N° de Police</th>
						<th style="border-right: 1px solid #bbb;text-align:center;">N° de la carte d'assuré</th>
						<th style="border-right: 1px solid #bbb;text-align:center;">Nom & Prenom du malade</th>
						<th style="border-right: 1px solid #bbb;text-align:center;">Nom & Prenom de l'Assureur Principal</th>
						<th style="border-right: 1px solid #bbb;text-align:center;"><?php echo 'Consultations';?></th>
						<th style="border-right: 1px solid #bbb;text-align:center;"><?php echo 'Services';?></th>
						<th style="border-right: 1px solid #bbb;text-align:center;"><?php echo 'Examen Compl.';?></th>
						<th style="border-right: 1px solid #bbb;text-align:center;"><?php echo 'Radiologie';?></th>
						<th style="border-right: 1px solid #bbb;text-align:center;"><?php echo 'Dental';?></th>
						<th style="border-right: 1px solid #bbb;text-align:center;"><?php echo 'Infirmerie';?></th>
						<th style="border-right: 1px solid #bbb;text-align:center;"><?php echo 'Consommables';?></th>
						<th style="border-right: 1px solid #bbb;text-align:center;"><?php echo 'Medicaments';?></th>
						<th style="border-right: 1px solid #bbb;text-align:center;">Montant 100%</th>
						<th style="border-right: 1px solid #bbb;text-align:center;">Montant <?php echo $nomassu;?></th>
			...
			?>
				...
				<tr style="text-align:center;">
					...
					<td style="text-align:center;">
						...
						if($_GET['percent']=="All")
						{
							echo $ligneGnlBillReport->numbill.' <br/>(<span style="font-weight:bold;">'.$ligneGnlBillReport->billpercent.'%</span>)';
						}else{
							echo $ligneGnlBillReport->numbill.'';
						}

							$percent = $ligneGnlBillReport->billpercent;
						?>
					</td>
					<?php
						...
						if($lignePatient=$resultPatient->fetch())
						{
							...
							if($ligneGnlBillReport->numpolicebill!="")
							{
							...
							if($ligneGnlBillReport->adherentbill!="")
							{
			...
			if($mois<0)
			{
				...
				// echo $mois= date('m')-$month;
							...
							echo '<td style="text-align:center;font-weight:bold;">'.$adherent.'</td>';
						}
					?>
				...
				if($comptMedConsu!=0 or $comptMedAutreConsu!=0)
				{
					if($comptMedConsu!=0)
					{
						while($ligneMedConsu=$resultMedConsu->fetch())//on recupere la liste des ꭩments
						{
				...
				?>
					...
					<td style="text-align:center;">
						...
						$resultMedLabo->setFetchMode(PDO::FETCH_OBJ);//on veut que le r괵ltat soit rꤵp곡ble sous forme d'objet
				...
				?>
					...
					$resultMedRadio->setFetchMode(PDO::FETCH_OBJ);//on veut que le r괵ltat soit rꤵp곡ble sous forme d'objet
				...
				if($comptMedRadio!=0 or $comptMedAutreRadio!=0)
				{
					...
					{
						while($ligneMedAutreRadio=$resultMedAutreRadio->fetch())//on recupere la liste des ꭩments
						{
				...
				?>										
							<tr>
								...
								<?php
									...
									echo $TotalMedSurge.'';
									//echo 'surgeinsu'.$TotalMedSurgeInsu.'';
				...
				if($comptMedInf!=0 or $comptMedAutreInf!=0)
				{
					...
					{
						while($ligneMedAutreInf=$resultMedAutreInf->fetch())//on recupere la liste des ꭩments
						{
				...
				?>
					...
					$resultMedConsom->setFetchMode(PDO::FETCH_OBJ);//on veut que le r괵ltat soit rꤵp곡ble sous forme d'objet
				...
				?>
					...
					{
						while($ligneMedAutreConsom=$resultMedAutreConsom->fetch())//on recupere la liste des ꭩments
						{
				...
				?>
					...
					$resultMedMedoc->setFetchMode(PDO::FETCH_OBJ);//on veut que le r괵ltat soit rꤵp곡ble sous forme d'objet
				...
				?>
					...
					{
						while($ligneMedAutreMedoc=$resultMedAutreMedoc->fetch())//on recupere la liste des ꭩments
						{
				...
				?>
					...
					<td style="text-align:center;font-weight: bold;"><?php echo $percent.'%';?></td>
				</tr>
				<?php
				...
				$TotalGnlPrice=$TotalGnlPrice + $TotalDayPrice;
					...
					$arrayGnlBillReport[$i][3]=$numeropolice;
					$arrayGnlBillReport[$i][4]=$carteassuid;
					$arrayGnlBillReport[$i][5]=$fullname;
					$arrayGnlBillReport[$i][6]=$adherent;
							
					$arrayGnlBillReport[$i][7]=$TotalTypeConsu;
					
					// $arrayGnlBillReport[$i][8]=$medconsu;		
					$arrayGnlBillReport[$i][8]=$TotalMedConsu;
										
					// $arrayGnlBillReport[$i][9]=$medlabo;		
					$arrayGnlBillReport[$i][9]=$TotalMedLabo;
					
					// $arrayGnlBillReport[$i][10]=$medradio;		
					$arrayGnlBillReport[$i][10]=$TotalMedRadio;
					
					// $arrayGnlBillReport[$i][11]=$medinf;		
					$arrayGnlBillReport[$i][11]=$TotalMedInf;
					
					// $arrayGnlBillReport[$i][12]=$medconsom;		
					$arrayGnlBillReport[$i][12]=$TotalMedConsom;
					
					// $arrayGnlBillReport[$i][13]=$medmedoc;		
					$arrayGnlBillReport[$i][13]=$TotalMedMedoc;
					
					$arrayGnlBillReport[$i][14]=$TotalDayPrice;
					$arrayGnlBillReport[$i][15]=$TotalDayPriceInsu;
					
					// if($_GET['percent'] =="All")
					// {
						$arrayGnlBillReport[$i][16]=$ligneGnlBillReport->billpercent.' %';
					//}
			...
			<?php
				...
				$objPHPExcel->setActiveSheetIndex(0)
							...
							->setCellValue('H'.(10+$i).'', ''.$TotalGnlTypeConsu.'')
							->setCellValue('I'.(10+$i).'', ''.$TotalGnlMedConsu.'')
							->setCellValue('J'.(10+$i).'', ''.$TotalGnlMedInf.'')
							->setCellValue('K'.(10+$i).'', ''.$TotalGnlMedLabo.'')
							->setCellValue('L'.(10+$i).'', ''.$TotalGnlMedRadio.'')
							->setCellValue('M'.(10+$i).'', ''.$TotalGnlMedConsom.'')
							->setCellValue('N'.(10+$i).'', ''.$TotalGnlMedMedoc.'')
							->setCellValue('O'.(10+$i).'', ''.$TotalGnlPrice.'')
							->setCellValue('P'.(10+$i).'', ''.$TotalGnlPriceInsu.'');
